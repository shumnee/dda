...
public class HomeController {
	...
	*/
	...
	@RequestMapping(value = "/moveInfo", method = RequestMethod.POST,produces = "application/json; charset=utf8")
	public void checmove(HttpServletResponse response, HttpServletRequest request, Model model) {
		...
		try {
			...
			String jsonStr = RRHandle.moveStar(m_id);
			if(jsonStr != null) {
				out.print(jsonStr);
				out.flush();
			}
	...
	@RequestMapping(value = "/getTicketInfo", method = RequestMethod.POST,produces = "application/json; charset=utf8")
	public void getticket(HttpServletResponse response, HttpServletRequest request, Model model) {
		//ModelAndView view = new ModelAndView("map");
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = null;
		String m_id = request.getParameter("m_id");
